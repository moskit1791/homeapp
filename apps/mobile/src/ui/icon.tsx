...
export const Bottle = createIcon("bottle-soda-outline");
...
export const CalendarRefresh = createIcon("calendar-refresh-outline");
export const Car = createIcon("car-outline");
export const CartPlus = createIcon("cart-plus");
export const CashPlus = createIcon("cash-plus");
export const ChartBar = createIcon("chart-bar");
export const Check = createIcon("check");
export const CheckCircle2 = createIcon("check-circle-outline");
export const CheckSquare = createIcon("checkbox-marked-outline");
...
export const DatabasePlus = createIcon("database-plus-outline");
...
export const Gamepad2 = createIcon("gamepad-variant-outline");
export const Gift = createIcon("gift-outline");
...
export const CardsView = createIcon("view-carousel-outline");
export const ListBulleted = createIcon("format-list-bulleted");
export const ListChecks = createIcon("format-list-checks");
export const ListPlus = createIcon("playlist-plus");
...
export const MapPin = createIcon("map-marker-outline");
...
export const Package = createIcon("package-variant-closed");
export const Pencil = createIcon("pencil-outline");
export const PiggyBank = createIcon("piggy-bank-outline");
...
export const ViewGrid = createIcon("view-grid-outline");
export const WalletCards = createIcon("wallet-outline");
export const WalletPlus = createIcon("wallet-plus-outline");
export const CreditCardClock = createIcon("credit-card-clock-outline");
export const Wrench = createIcon("wrench-outline");
