...
const envSchema = z.object({
  ...
  GEMINI_MEAL_SUGGESTION_MODEL: optionalNonEmptyString.default('gemini-2.5-pro'),
  GEMINI_MEAL_SUGGESTION_THINKING_BUDGET: z.coerce.number().int().nonnegative().default(4096),
  GEMINI_MEAL_SUGGESTION_TIMEOUT_MS: z.coerce.number().int().positive().default(60_000),
