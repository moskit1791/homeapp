  ...
  return (
    <>
      <ComponentBox title="General">
        ...
        {(variant === 'filled' && (
          <FilledInput id={inputId} fullWidth hiddenLabel placeholder="Filled Input" />
        )) ||
          (variant === 'outlined' && (
            <OutlinedInput id={inputId} fullWidth placeholder="Outlined Input" />
          )) || <Input id={inputId} fullWidth placeholder="Input" />}
      </ComponentBox>
