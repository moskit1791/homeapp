...
export function CalendarPage() {
  ...
  const [scopeType, setScopeType] = useState<"household" | "member">(
    "household",
  );
  ...
  const grouped = (events.data ?? []).reduce<
    Record<string, typeof events.data>
  >((acc, event) => {
    ...
    <Page>
                    ...
                    {items?.map((event) => (
                      ...
                      >
                        ...
                        <Chip
                          size="small"
                          label={
                            event.scopeType === "member" ? "Prywatne" : "Dom"
                          }
                          variant="outlined"
                        />
      ...
      >
        ...
        <TextField
          ...
          value={scopeType}
          onChange={(e) =>
            setScopeType(e.target.value as "household" | "member")
          }
        >
